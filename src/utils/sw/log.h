...
namespace LOG
{
  ...
  constexpr void LOG(const char *file, int line,
  ...
  #define D(...) \
    LOG(__FILE__, __LINE__, " \033[37;44;1m D \033[0m\033[34m ", __VA_ARGS__)
  ...
  /// - '\\' can be used as an escape character.
  #define I(...) \
    LOG(__FILE__, __LINE__, " \033[37;42;1m I \033[0m\033[32m ", __VA_ARGS__)
  ...
  /// - '\\' can be used as an escape character.
  #define W(...) \
    LOG(__FILE__, __LINE__, " \033[30;43;1m W \033[0m\033[33m ", __VA_ARGS__)
  ...
  /// - '\\' can be used as an escape character.
  #define E(...) \
    LOG(__FILE__, __LINE__, " \033[30;41;1m E \033[0m\033[31m ", __VA_ARGS__)
